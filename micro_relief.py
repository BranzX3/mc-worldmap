...
BED_SLOPE_FULL = 1.60
# ต้องเป็น 1.0 (สแนปเต็ม) ไม่งั้นเพื่อนบ้านที่อยู่ชั้นเดียวกันยังต่างกัน
# (1-strength)*ความชัน ซึ่งพอปัดเป็นบล็อกก็แยกกันอยู่ดี ชานจึงไม่เกิด
# วัดได้: st .75 -> ชาน 1.52 | st 1.0 -> ชาน 1.95 (ไม่มี bedding เลย = 1.43)
BED_STRENGTH = 1.0
